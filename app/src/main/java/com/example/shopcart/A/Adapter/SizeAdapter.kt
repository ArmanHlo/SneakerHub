...
import com.example.shopcart.databinding.ViewholderSizeBinding
...
RecyclerView.Adapter<SizeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SizeAdapter.ViewHolder, position: Int) {
        ...
        if (selectedPosition == position) {
            ...
            holder.binding.sizeTxt.setTextColor(holder.binding.root.context.getColor(R.color.white))
        } else {
            holder.binding.root.setBackgroundResource(R.drawable.stroke_bg_blue)
            holder.binding.sizeTxt.setTextColor(holder.binding.root.context.getColor(R.color.black))
        }
