...
import com.example.shopcart.databinding.ViewholderBrandBinding
...
class BrandsAdapter(private val items: MutableList<BrandModel>):
 RecyclerView.Adapter<BrandsAdapter.Viewholder>(){
    ...
    override fun onBindViewHolder(holder: BrandsAdapter.Viewholder, @SuppressLint("RecyclerView") position: Int) {
